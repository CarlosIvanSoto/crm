...
const EMPTY_STATES = {
	all: {
		...
		description:
			"Notes, calls and tasks all land here. Log the first one above.",
	},
	notes: {
		title: "No notes",
		description:
			"Notes are what you write down for the next person to read — what the traveller cares about, what you promised, who else is involved.",
	},
	upcoming: {
		title: "Nothing outstanding",
		description:
			"Tasks nobody has finished appear here, and at the top of the All tab until they are done.",
	},
	done: {
		title: "Nothing finished yet",
		description: "Tasks move here once they are ticked off.",
	},
