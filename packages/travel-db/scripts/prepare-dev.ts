...
if (drift === 2) {
	console.error(
		"The database and Prisma schema differ. Reconcile the migration history with `bun run travel:migrate` before starting dev.",
	);
	process.exit(1);
}
...
console.log(
	"Travel database migrations and generated Prisma client are ready.",
);
